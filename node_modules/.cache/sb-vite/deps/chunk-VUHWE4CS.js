...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-DZD642IB.js";
import {
  ActionBar
} from "./chunk-N3J5P5SG.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-ANKCEFPB.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-ZAMOW4IQ.js";
import {
  O
} from "./chunk-SCIMNOBX.js";
import {
  require_core_events
} from "./chunk-LNJFWAS6.js";
import {
  stringify
} from "./chunk-EVFWSLIG.js";
import {
  esm_default
} from "./chunk-J6CEENEN.js";
import {
  index_modern_default
} from "./chunk-P4KDCNP3.js";
import {
  require_memoizerific
} from "./chunk-MPSLWC65.js";
import {
  curriedDarken$1,
  curriedLighten$1,
  curriedOpacify$1,
  ...
  rgba
} from "./chunk-U6Q5MJZN.js";
import {
  require_uniq
} from "./chunk-GY4TXMVU.js";
import {
  require_mapValues
} from "./chunk-XVNWLMMX.js";
import {
  require_pickBy
} from "./chunk-P355ECVS.js";
import {
  require_cloneDeep
} from "./chunk-XWUP6XK7.js";
import {
...
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => import_react.default.createElement(Bar, { ...rest }, import_react.default.createElement(import_react.Fragment, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react.default.createElement(IconButtonSkeleton, { key })) : import_react.default.createElement(Zoom2, { zoom, resetZoom })));
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-NNXKAVCY.js");
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onSetFalse }, "Set boolean");
...
var NumberControl = ({ name, value: value2, onChange, min, max, step, onBlur, onFocus }) => {
  ...
  }, [value2]), !forceVisible && value2 === void 0 ? import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set number") : import_react.default.createElement(Wrapper2, null, import_react.default.createElement(Form.Input, { ref: htmlElRef, id: getControlId(name), type: "number", onChange: handleChange, size: "flex", placeholder: "Edit number...", value: inputValue, valid: parseError ? "error" : null, autoFocus: forceVisible, name, min, max, step, onFocus, onBlur }));
};
...
var CheckboxControl = ({ name, options, value: value2, onChange, isInline }) => {
  ...
  return import_react.default.createElement(Wrapper3, { isInline }, Object.keys(options).map((key, index) => {
...
var SingleSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react.default.createElement(SelectWrapper, null, import_react.default.createElement(Icons, { icon: "arrowdown" }), import_react.default.createElement(OptionsSelect, { id: controlId, value: selection, onChange: handleChange }, import_react.default.createElement("option", { key: "no-selection", disabled: true }, NO_SELECTION), Object.keys(options).map((key) => import_react.default.createElement("option", { key, value: key }, key))));
};
...
var ObjectControl = ({ name, value: value2, onChange }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
  let rawJSONForm = import_react.default.createElement(RawInput, { ref: htmlElRef, id: getControlId(name), name, defaultValue: value2 === null ? "" : JSON.stringify(value2, null, 2), onBlur: (event) => updateRaw(event.target.value), placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : null });
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength }) => {
  ...
  if (value2 === void 0)
    return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
  let isValid = typeof value2 == "string";
  return import_react.default.createElement(Wrapper6, null, import_react.default.createElement(Form.Textarea, { id: getControlId(name), maxLength, onChange: handleChange, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? null : "error", name, value: isValid ? value2 : "", onFocus, onBlur }), maxLength && import_react.default.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-TJCMUJBT.js"));
...
var ArgRow = (props) => {
  var _a;
  let [isHovered, setIsHovered] = (0, import_react.useState)(false), { row, updateArgs, compact, expandable, initialExpandedArgs } = props, { name, description } = row, table = row.table || {}, type = table.type || row.type, defaultValue = table.defaultValue || row.defaultValue, required = (_a = row.type) == null ? void 0 : _a.required, hasDescription = description != null && description !== "";
...
var useArgs = (storyId, context) => {
  let storyContext = context.getStoryContext(context.storyById()), [args, setArgs] = (0, import_react.useState)(storyContext.args);
  (0, import_react.useEffect)(() => {
    let cb = (changed) => {
...
var StoryTable = (props) => {
  ...
  try {
    ...
    let argTypes = (0, import_preview_api.filterArgTypes)(story.argTypes, include, exclude), mainLabel = getComponentName(component) || "Story", tabs = { [mainLabel]: { rows: argTypes, args, globals, updateArgs, resetArgs } }, storyHasArgsWithControls = argTypes && Object.values(argTypes).find((v) => !!(v == null ? void 0 : v.control));
...
var useSourceProps = (props, docsContext, sourceContext) => {
  ...
  code || (code = stories.map((story, index) => {
    ...
    return index === 0 && (format2 = source.format ?? ((_b2 = (_a2 = story.parameters.docs) == null ? void 0 : _a2.source) == null ? void 0 : _b2.format) ?? false), getSnippet({ snippet: source.code, storyContext: { ...storyContext, args: argsForSource }, typeFromProps: props.type, transformFromProps: props.transform });
  }).join(`
...
var Canvas = (props) => {
  ...
  let docsContext = (0, import_react.useContext)(DocsContext), sourceContext = (0, import_react.useContext)(SourceContext), { children, of, source } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
...
var Controls3 = (props) => {
  ...
  return import_react.default.createElement(ArgsTable, { rows: filteredArgTypes, args, globals, updateArgs, resetArgs, sort });
};
...
var Primary = (props) => {
  ...
  return name && (0, import_client_logger.deprecate)(esm_default`\`name\` prop is deprecated on the Primary block.
...
//# sourceMappingURL=chunk-VUHWE4CS.js.map

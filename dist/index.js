...
const FormField = ({
  ...
  const updateFormState = (target, isCheckbox) => setFormState({
    ...formState,
    [config.field]: isCheckbox ? target.checked : target.value,
    _isValidField: {
      ...formState._isValidField,
      [config.field]: target.checkValidity()
    }
  });
  const renderLabel = () => /*#__PURE__*/jsxRuntime.jsx("label", {
    htmlFor: elId,
  ...
  const renderField = () => {
    if (config.inputProps.type === 'dropdown') {
      return /*#__PURE__*/jsxRuntime.jsx("select", {
        ...
        children: config.inputProps.options?.map(option => /*#__PURE__*/jsxRuntime.jsx("option", {
          value: option.value,
          ...(config.inputProps.selected === option.value ? {
            selected: true
          } : {
            selected: false
          }),
      ...
      return /*#__PURE__*/jsxRuntime.jsx("input", {
        ...
        onChange: onChange,
        name: config.field,
        checked: config.inputProps.type !== 'radio' ? formState[config.field] : formState[config.field] === config.inputProps.value,
        className: inputClass
      });
    }
  };
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    className: `rqf-el ${containerClass}`,
    children: [(!config.labelPosition || config.labelPosition === 'start') && renderLabel(), renderField(), config.labelPosition === 'end' && renderLabel(), formState._isValidField[config.field] !== undefined && !formState._isValidField[config.field] && /*#__PURE__*/jsxRuntime.jsx("div", {
      className: `invalid-feedback d-flex ${errorClass}`,
      children: config.validation?.errorMessage
    })]
  });
};
...
const mergeFieldsConfig = (config1, config2) => {
...
const mergeActionsConfig = (config1, config2) => {
  const config1GroupByField = {};
...
var FormPresets = /*#__PURE__*/Object.freeze({
  __proto__: null,
  login: login,
  register: register
});
...
const Form = ({
  ...
  const [formState, setFormState] = react.useState(resetFormState());
  const handleAction = ({
    type
  }) => {
    switch (type) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("form", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("header", {
      className: "rqf-header",
      children: /*#__PURE__*/jsxRuntime.jsx("h1", {
        children: name
      })
    }), /*#__PURE__*/jsxRuntime.jsx("main", {
      className: `rqf-main ${formCss.formContainerClass}`,
      children: formFieldsConfig.map(fieldConfig => {
        return /*#__PURE__*/jsxRuntime.jsx(FormField, {
          formName: name,
          config: fieldConfig,
          formState: formState,
          formCss: formCss,
      ...
      className: "rqf-footer",
      children: formActionsConfig.map(actionConfig => {
        return /*#__PURE__*/jsxRuntime.jsx("div", {
          className: `rqf-action ${actionConfig.css?.containerClass}`,
          children: /*#__PURE__*/jsxRuntime.jsx("button", {
            ...
            disabled: Object.values(formState._isValidField).includes(undefined) || Object.values(formState._isValidField).includes(false),
...
Form.propTypes = {
   ...
   */
  preset: propTypesExports.string,
  /**
   * Custom form configuration
   */
  config: propTypesExports.object,
  /**

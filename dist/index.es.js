...
const FormField = ({
  ...
  const renderLabel = () => /*#__PURE__*/jsx("label", {
    htmlFor: elId,
  ...
  const renderField = () => {
    if (config.inputProps.type === 'dropdown') {
      return /*#__PURE__*/jsx("select", {
        ...
        children: config.inputProps.options?.map(option => /*#__PURE__*/jsx("option", {
          value: option.value,
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [(!config.labelPosition || config.labelPosition === 'start') && renderLabel(), renderField(), config.labelPosition === 'end' && renderLabel(), formState._isValidField[config.field] !== undefined && !formState._isValidField[config.field] && /*#__PURE__*/jsx("div", {

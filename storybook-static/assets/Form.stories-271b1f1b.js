import{F as l}from"./Form-f0678954.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";import"./index-9d475cdf.js";const d={title:"Form",component:l,tags:["autodocs"],parameters:{layout:"centered"},argTypes:{preset:{options:["login","register"],control:{type:"radio",labels:{login:"Login",register:"Register"}}},onSubmit:{action:"Form State: "}}},e={args:{preset:"login"}},r={args:{preset:"login",config:{fields:[{label:"Age",field:"age",order:22,inputProps:{type:"number",max:100,min:18},validation:{errorMessage:"Please enter valid age!"},css:{labelClass:"form-label",inputClass:"form-control",containerClass:"mt-4"}}]}}};var n,s,o;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    preset: 'login'
  }
